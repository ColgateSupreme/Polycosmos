...
def setup_location_table_with_settings(options) -> None:
    ...
    if options.mirrorsanity.value >= 1:
        ...
        if routine_inspection < 1 and options.mirrorsanity.value == 4:
            total_table.update(location_table_mirror_4)
        if routine_inspection < 2 and options.mirrorsanity.value >= 3:
            total_table.update(location_table_mirror_3)
        if routine_inspection < 3 and options.mirrorsanity.value >= 2:
            total_table.update(location_table_mirror_2)
        if routine_inspection < 4 and options.mirrorsanity.value >= 1:
